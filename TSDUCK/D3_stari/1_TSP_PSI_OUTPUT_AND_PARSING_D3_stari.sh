...
MPTS=$1
OUTPUT_TSP_PSI_FILE="/root/outputs/D3_stari/tsp_PSI_output/$MPTS"
OUTPUT_TSP_TSDATE_FILE="/root/outputs/D3_stari/tsp_tsdate_output/$MPTS"
...
for SDT_OTHER_TSID in $(seq 101 144)
do
	echo ""
