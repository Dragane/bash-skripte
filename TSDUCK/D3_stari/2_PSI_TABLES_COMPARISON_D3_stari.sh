...
do
	...
	INPUT_TSP_PSI_FILE="/root/outputs/D3_stari/PSI_output_parsed/$MPTS"
	INPUT_TSP_TSDATE_FILE="/root/outputs/D3_stari/tsp_tsdate_output/$MPTS"
	...
	then
		...
		do
			OTHER_MPTS="232.200.1.$OTHER_MPTS_DIGITS:5200"
			INPUT_TSP_PSI_FILE="/root/outputs/D3_stari/PSI_output_parsed/$OTHER_MPTS"
