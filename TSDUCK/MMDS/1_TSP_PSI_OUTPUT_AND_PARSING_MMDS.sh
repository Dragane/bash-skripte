#!/bin/bash
MPTS=$1
OUTPUT_TSP_PSI_FILE="/root/outputs/MMDS/tsp_PSI_output/$MPTS"
OUTPUT_TSP_TSDATE_FILE="/root/outputs/MMDS/tsp_tsdate_output/$MPTS"
...
echo "-------------------------------------------------------------------------------"
for SDT_OTHER_TSID in $(seq 201 224)
do
	echo ""
