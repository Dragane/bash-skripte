...
STREAMURL="http://93.103.175.209:8000"
MULTICAST="232.50.51.29:5200"
RADIONAME="Radio\ Brezje"
...
then
        ...
        /root/bin/ffmpeg \
                ...
                -i $STREAMURL \
                -c:a mp2 `# Kodek.` \
                -b:a 192k `# Radio Brezje mora imeti 64, ker drugače ffmpeg javlja bitrate not allowed.` \
                -map_metadata 0 \
